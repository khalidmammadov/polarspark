...
from plspark import accumulators
from plspark.accumulators import Accumulator
# from plspark.broadcast import Broadcast, BroadcastPickleRegistry
from plspark.conf import SparkConf
from plspark.files import SparkFiles
# from plspark.java_gateway import launch_gateway, local_connect_and_auth
...
# from plspark.resource.information import ResourceInformation
from plspark.rdd import RDD#, _load_from_socket
# from plspark.taskcontext import TaskContext
from plspark.traceback_utils import CallSite, first_spark_call
# from plspark.status import StatusTracker
# from plspark.profiler import ProfilerCollector, BasicProfiler, UDFBasicProfiler, MemoryProfiler
from plspark.errors import PySparkRuntimeError

if TYPE_CHECKING:
    from plspark.accumulators import AccumulatorParam
...
class SparkContext:
    ...
    def __init__(
        ...
        SparkContext._ensure_initialized(self, conf=conf)
        try:
            self._do_init(
                master,
                appName,
...
#         See Also
#         --------
#         :meth:`plspark.sql.SparkSession.range`
#
#         Examples
#         --------
#         >>> sc.range(5).collect()
...
#         serializer : class:`plspark.serializers.Serializer`
...
#         value : T
#             initialized value
#         accum_param : :class:`plspark.AccumulatorParam`, optional
...
#         >>> import os
#         >>> import tempfile
#         >>> from plspark import SparkFiles
#
#         >>> with tempfile.TemporaryDirectory() as d:
...
#         """
#         Returns a Java StorageLevel based on a plspark.StorageLevel.
#         """
#         if not isinstance(storageLevel, StorageLevel):
#             raise TypeError("storageLevel must be of type plspark.StorageLevel")
#         assert self._jvm is not None
...
#
#         If you run jobs in parallel, use :class:`plspark.InheritableThread` for thread
#         local inheritance.
#
#         See Also
#         --------
...
#         >>> from plspark import InheritableThread
#         >>> result = "Not Set"
#         >>> lock = threading.Lock()
#         >>> def map_func(x):
#         ...     sleep(100)
