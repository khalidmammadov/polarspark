...
# from plspark.serializers import read_int, CPickleSerializer
from plspark.errors import PySparkRuntimeError

if TYPE_CHECKING:
    from plspark._typing import SupportsIAdd  # noqa: F401
...
def _deserialize_accumulator(
    ...
    from plspark.accumulators import _accumulatorRegistry
