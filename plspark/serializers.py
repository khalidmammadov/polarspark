...
>>> from plspark.serializers import MarshalSerializer
...
from plspark import cloudpickle
from plspark.util import print_exec
...
class CartesianDeserializer(Serializer):
    ...
    Due to plspark batching we cannot simply use the result of the Java RDD cartesian,
...
class PairDeserializer(Serializer):
    ...
    Due to plspark batching we cannot simply use the result of the Java RDD zip,
