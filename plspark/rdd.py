...
from plspark.serializers import (
...
# from plspark.statcounter import StatCounter
# from plspark.rddsampler import RDDSampler, RDDRangeSampler, RDDStratifiedSampler
from plspark.storagelevel import StorageLevel
# from plspark.resource.requests import ExecutorResourceRequests, TaskResourceRequests
# from plspark.resource.profile import ResourceProfile
# from plspark.resultiterable import ResultIterable
# from plspark.shuffle import (
#     Aggregator,
#     ExternalMerger,
#     get_used_memory,
#     ExternalSorter,
#     ExternalGroupBy,
# )
from plspark.traceback_utils import SCCallSiteSync
from plspark.util import fail_on_stopiteration, _parse_memory
from plspark.errors import PySparkRuntimeError
...
if TYPE_CHECKING:
    ...
    from plspark._typing import NonUDFType
    from plspark._typing import S, NumberOrArray
    from plspark.context import SparkContext
    # from plspark.sql.pandas._typing import (
    #     PandasScalarUDFType,
    ...
    from plspark.sql.types import AtomicType, StructType
...
class RDD(Generic[T_co]):
    ...
    def persist(self: "RDD[T]", storageLevel: StorageLevel = StorageLevel.MEMORY_ONLY) -> "RDD[T]":
        ...
        >>> from plspark import StorageLevel
        >>> rdd2 = sc.range(5)
    ...
    def sample(
        ...
        :meth:`plspark.sql.DataFrame.sample`
    ...
    def randomSplit(
        ...
        See Also
        --------
        :meth:`plspark.sql.DataFrame.randomSplit`
    ...
    def union(self: "RDD[T]", other: "RDD[U]") -> "RDD[Union[T, U]]":
        ...
        :meth:`plspark.sql.DataFrame.union`
    ...
    def intersection(self: "RDD[T]", other: "RDD[T]") -> "RDD[T]":
        ...
        See Also
        --------
        :meth:`plspark.sql.DataFrame.intersect`
    ...
    def sortByKey(
        ...
        --------
        :meth:`RDD.sortBy`
        :meth:`plspark.sql.DataFrame.sort`
    ...
    def cartesian(self: "RDD[T]", other: "RDD[U]") -> "RDD[Tuple[T, U]]":
        ...
        See Also
        --------
        :meth:`plspark.sql.DataFrame.crossJoin`
    ...
    def groupBy(
        ...
        --------
        :meth:`RDD.groupByKey`
        :meth:`plspark.sql.DataFrame.groupBy`
    ...
    def foreach(self: "RDD[T]", f: Callable[[T], None]) -> None:
        ...
        :meth:`plspark.sql.DataFrame.foreach`
        :meth:`plspark.sql.DataFrame.foreachPartition`
    ...
    def collect(self: "RDD[T]") -> List[T]:
        ...
        :meth:`plspark.sql.DataFrame.collect`
    ...
    def collectWithJobGroup(
        ...
        .. deprecated:: 3.1.0
            Use :class:`plspark.InheritableThread` with the pinned thread mode enabled.
        ...
        """
        warnings.warn(
            "Deprecated in 3.1, Use plspark.InheritableThread with "
    ...
    def count(self) -> int:
        ...
        :meth:`plspark.sql.DataFrame.count`
    ...
    #     :meth:`RDD.histogram`
    #     :meth:`plspark.sql.DataFrame.stat`
    #     """
    #
    ...
    def take(self: "RDD[T]", num: int) -> List[T]:
        ...
        --------
        :meth:`RDD.first`
        :meth:`plspark.sql.DataFrame.take`
    ...
    def first(self: "RDD[T]") -> T:
        ...
        --------
        :meth:`RDD.take`
        :meth:`plspark.sql.DataFrame.first`
        :meth:`plspark.sql.DataFrame.head`
    ...
    def isEmpty(self) -> bool:
        ...
        --------
        :meth:`RDD.first`
        :meth:`plspark.sql.DataFrame.isEmpty`
    ...
    def saveAsPickleFile(self, path: str, batchSize: int = 10) -> None:
        ...
        used is :class:`plspark.serializers.CPickleSerializer`, default batch size
        is 10.
    ...
    def join(
        ...
        :meth:`RDD.cogroup`
        :meth:`RDD.groupWith`
        :meth:`plspark.sql.DataFrame.join`
    ...
    def toLocalIterator(self: "RDD[T]", prefetchPartitions: bool = False) -> Iterator[T]:
        ...
        --------
        :meth:`RDD.collect`
        :meth:`plspark.sql.DataFrame.toLocalIterator`
    ...
    def barrier(self: "RDD[T]") -> "RDDBarrier[T]":
        ...
        See Also
        --------
        :class:`plspark.BarrierTaskContext`
    ...
    #     """
    #     Specify a :class:`plspark.resource.ResourceProfile` to use when calculating this RDD.
    ...
    #     Parameters
    #     ----------
    #     profile : :class:`plspark.resource.ResourceProfile`
    #         a resource profile
    #
    #     Returns
    #     -------
    ...
    #     """
    #     Get the :class:`plspark.resource.ResourceProfile` specified with this RDD or None
    ...
    #     Returns
    #     -------
    #     class:`plspark.resource.ResourceProfile`
