...
class DataFrameReader(OptionUtils):
    ...
    def schema(self, schema: Union[StructType, str]) -> "DataFrameReader":
        ...
        Parameters
        ----------
        schema : :class:`plspark.sql.types.StructType` or str
            a :class:`plspark.sql.types.StructType` object or a DDL-formatted string
    ...
    def load(
        ...
        **options: "OptionalPrimitiveType",
        ...
        schema : :class:`plspark.sql.types.StructType` or str, optional
            optional :class:`plspark.sql.types.StructType` for the input schema
    ...
    def json(
        ...
        schema : :class:`plspark.sql.types.StructType` or str, optional
            an optional :class:`plspark.sql.types.StructType` for the input schema or
    ...
    def csv(
        ...
        schema : :class:`plspark.sql.types.StructType` or str, optional
            an optional :class:`plspark.sql.types.StructType` for the input schema
            or a DDL-formatted string (For example ``col0 INT, col1 DOUBLE``).
...
class DataFrameWriter(OptionUtils):
    ...
    def options(self, **options: "OptionalPrimitiveType") -> "DataFrameWriter":
        ...
        **options : dict
        ...
        >>> from plspark.sql.types import StructType,StructField, StringType, IntegerType
        >>> schema = StructType([
    ...
    def bucketBy(
        ...
        >>> from plspark.sql.functions import input_file_name
...
class DataFrameWriterV2:
    """
    Interface used to write a class:`plspark.sql.dataframe.DataFrame`
    ...
    def partitionedBy(self, col: Column, *cols: Column) -> "DataFrameWriterV2":
        ...
        * :py:func:`plspark.sql.functions.years`
        * :py:func:`plspark.sql.functions.months`
        * :py:func:`plspark.sql.functions.days`
        * :py:func:`plspark.sql.functions.hours`
        * :py:func:`plspark.sql.functions.bucket`
...
def _test() -> None:
    ...
    from plspark.sql import SparkSession
    import plspark.sql.readwriter

    os.chdir(os.environ["SPARK_HOME"])

    globs = plspark.sql.readwriter.__dict__.copy()
