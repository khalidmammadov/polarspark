...
# from plspark.serializers import CloudPickleSerializer
from plspark.sql.utils import has_numpy, get_active_spark_context
from plspark.errors import PySparkNotImplementedError, PySparkTypeError, PySparkValueError
...
class DataType:
    ...
    def fromDDL(cls, ddl: str) -> "DataType":
        ...
        ddl : str
            ...
            :class:`plspark.sql.types.DataType.simpleString`, except that top level struct
        ...
        >>> from plspark.sql.types import DataType
        ...
        from plspark.sql.functions import udf
...
class ArrayType(DataType):
    ...
    Examples
    --------
    >>> from plspark.sql.types import ArrayType, StringType, StructField, StructType
...
class MapType(DataType):
    ...
    Examples
    --------
    >>> from plspark.sql.types import IntegerType, FloatType, MapType, StringType
...
class StructField(DataType):
    ...
    Examples
    --------
    >>> from plspark.sql.types import StringType, StructField
...
class StructType(DataType):
    ...
    def add(
        ...
        Examples
        --------
        >>> from plspark.sql.types import IntegerType, StringType, StructField, StructType
    ...
    def fieldNames(self) -> List[str]:
        ...
        Examples
        --------
        >>> from plspark.sql.types import StringType, StructField, StructType
...
def _make_type_verifier(
    ...
    Traceback (most recent call last):
        ...
    plspark.errors.exceptions.base.PySparkValueError:...
    >>> _make_type_verifier(ArrayType(ShortType()))(list(range(3)))
    >>> _make_type_verifier(ArrayType(StringType()))(set()) # doctest: +IGNORE_EXCEPTION_DETAIL
    Traceback (most recent call last):
        ...
    plspark.errors.exceptions.base.PySparkTypeError:...
