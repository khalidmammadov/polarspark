...
# from polarspark.shuffle import (
#     Aggregator,
#     ExternalMerger,
#     get_used_memory,
#     ExternalSorter,
...
from polarspark.util import fail_on_stopiteration, _parse_memory
...
if TYPE_CHECKING:
    ...
    from polarspark.sql.types import AtomicType, StructType
...
class RDD(Generic[T_co]):
    ...
    def sample(
        ...
        :meth:`polarspark.sql.DataFrame.sample`
    ...
    def randomSplit(
        ...
        See Also
        --------
        :meth:`polarspark.sql.DataFrame.randomSplit`
    ...
    def union(self: "RDD[T]", other: "RDD[U]") -> "RDD[Union[T, U]]":
        ...
        :meth:`polarspark.sql.DataFrame.union`
    ...
    def intersection(self: "RDD[T]", other: "RDD[T]") -> "RDD[T]":
        ...
        See Also
        --------
        :meth:`polarspark.sql.DataFrame.intersect`
    ...
    def sortByKey(
        ...
        --------
        :meth:`RDD.sortBy`
        :meth:`polarspark.sql.DataFrame.sort`
    ...
    def cartesian(self: "RDD[T]", other: "RDD[U]") -> "RDD[Tuple[T, U]]":
        ...
        See Also
        --------
        :meth:`polarspark.sql.DataFrame.crossJoin`
    ...
    def groupBy(
        ...
        --------
        :meth:`RDD.groupByKey`
        :meth:`polarspark.sql.DataFrame.groupBy`
    ...
    def foreach(self: "RDD[T]", f: Callable[[T], None]) -> None:
        ...
        :meth:`polarspark.sql.DataFrame.foreach`
        :meth:`polarspark.sql.DataFrame.foreachPartition`
    ...
    def collect(self: "RDD[T]") -> List[T]:
        ...
        :meth:`polarspark.sql.DataFrame.collect`
    ...
    def collectWithJobGroup(
        ...
        .. deprecated:: 3.1.0
            Use :class:`polarspark.InheritableThread` with the pinned thread mode enabled.
        ...
        """
        warnings.warn(
            "Deprecated in 3.1, Use polarspark.InheritableThread with "
    ...
    def count(self) -> int:
        ...
        :meth:`polarspark.sql.DataFrame.count`
    ...
    #     :meth:`RDD.histogram`
    #     :meth:`polarspark.sql.DataFrame.stat`
    #     """
    #
    ...
    def take(self: "RDD[T]", num: int) -> List[T]:
        ...
        --------
        :meth:`RDD.first`
        :meth:`polarspark.sql.DataFrame.take`
    ...
    def first(self: "RDD[T]") -> T:
        ...
        --------
        :meth:`RDD.take`
        :meth:`polarspark.sql.DataFrame.first`
        :meth:`polarspark.sql.DataFrame.head`
    ...
    def isEmpty(self) -> bool:
        ...
        --------
        :meth:`RDD.first`
        :meth:`polarspark.sql.DataFrame.isEmpty`
    ...
    def saveAsPickleFile(self, path: str, batchSize: int = 10) -> None:
        ...
        used is :class:`polarspark.serializers.CPickleSerializer`, default batch size
        is 10.
    ...
    def join(
        ...
        :meth:`RDD.cogroup`
        :meth:`RDD.groupWith`
        :meth:`polarspark.sql.DataFrame.join`
    ...
    def toLocalIterator(self: "RDD[T]", prefetchPartitions: bool = False) -> Iterator[T]:
        ...
        --------
        :meth:`RDD.collect`
        :meth:`polarspark.sql.DataFrame.toLocalIterator`
    ...
    def barrier(self: "RDD[T]") -> "RDDBarrier[T]":
        ...
        See Also
        --------
        :class:`polarspark.BarrierTaskContext`
    ...
    #     """
    #     Specify a :class:`polarspark.resource.ResourceProfile` to use when calculating this RDD.
    ...
    #     Parameters
    #     ----------
    #     profile : :class:`polarspark.resource.ResourceProfile`
    #         a resource profile
    #
    #     Returns
    #     -------
    ...
    #     """
    #     Get the :class:`polarspark.resource.ResourceProfile` specified with this RDD or None
    ...
    #     Returns
    #     -------
    #     class:`polarspark.resource.ResourceProfile`
